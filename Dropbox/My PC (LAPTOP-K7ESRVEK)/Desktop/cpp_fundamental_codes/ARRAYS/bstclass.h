...
public:
    ...
    private:
    binarytreenode<int>*helper_delete(binarytreenode<int>*root,int key)
    {
        if(root==NULL)
        {
            return NULL;
            ...
            if(root->data==key)
              {
                  ...
                  else if(root->right==NULL&&root->left!=NULL)
                  {
                      ...
                      return temp;
                       ...
                       root->right=deleteData(root->right,rightminel);
                       return root;
...
private:
    binarytreenode<int>* helper_insert(binarytreenode<int>*node,int data)
    {
        ...
        binarytreenode<int>*lroot,rroot;
        if(data<node->data)
        {
